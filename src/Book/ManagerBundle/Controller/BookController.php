...
use Book\ManagerBundle\Entity\Book;
use Book\ManagerBundle\Form\BookType;

class BookController extends Controller {

	public function indexAction() {
		$em = $this->getDoctrine()->getManager();
		$books = $em->getRepository('BookManagerBundle:Book')->findAll();
		return $this->render('BookManagerBundle:Book:index.html.twig', array(
			'books'=>$books
		));
	}
	...
	public function showAction($id) {
		$em = $this->getDoctrine()->getManager();
		$book = $em->getRepository('BookManagerBundle:Book')->find($id);
		...
		return $this->render('BookManagerBundle:Book:show.html.twig', array(
			'book'=>$book,
	...
	public function newAction() {
		...
		return $this->render('BookManagerBundle:Book:new.html.twig', array(
	...
	public function editAction($id) {
		...
		return $this->render('BookManagerBundle:Book:edit.html.twig', array(
			'form'=>$form->createView()
		));
	}
